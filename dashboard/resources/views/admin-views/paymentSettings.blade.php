                        ...
                        <div class="col-12">
                            <div class="row">
								...
								<div class="col-12">
                                    <div class="form-group lang_form">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{\App\CentralLogics\translate('Paypal Client Secret')}}</label>
                                        @php
                                            $paypalClientSecret = \App\WebSetting::WHERE("key", 'paypalClientSecret')->first() ? \App\WebSetting::WHERE("key", 'paypalClientSecret')->first()->value : "";
                                        @endphp
                                        <input type="text" name="data[paypalClientSecret]" value="{{$paypalClientSecret}}"
                                               class="form-control">
                                    </div>
                                </div>
								...
								<div class="col-12">
                                    <div class="form-group lang_form">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{\App\CentralLogics\translate('Paypal App Id')}}</label>
                                        @php
                                            $paypalappId = \App\WebSetting::WHERE("key", 'paypalappId')->first() ? \App\WebSetting::WHERE("key", 'paypalappId')->first()->value : "";
                                        @endphp
                                        <input type="text" name="data[paypalappId]" value="{{$paypalappId}}"
                                               class="form-control">
                                    </div>
                                </div>
								...
								<div class="col-12">
                                    <div class="form-group lang_form">
                                        <label class="input-label"
                                               for="exampleFormControlInput1">{{\App\CentralLogics\translate('Paypal mode')}}</label>
                                        @php
                                            $paypalmode = \App\WebSetting::WHERE("key", 'paypalmode')->first() ? \App\WebSetting::WHERE("key", 'paypalmode')->first()->value : "";
                                        @endphp
                                        <select name="data[paypalmode]" class="form-control">
										<option value="sandbox" <?php echo ($paypalmode=='sandbox')?'selected':'';?> >Sandbox</option>
										<option value="live" <?php echo ($paypalmode=='live')?'selected':'';?>>Live</option>
										</select>
                                    </div>
                                </div>
                                <!--<div class="col-12">
