...
|
*/
Route::any('/getnits', [AppPageController::class, 'getnits'])->name('getnits');
Route::any('/getnits_ajax', [AppPageController::class, 'getnits_ajax'])->name('getnits_ajax');

Route::post('/save_status', [PayPalController::class, 'save_status'])->name('save_status');
...
Route::get('oauth/{appid}',[GoogleAuth::class, 'oauthApp'])->name('oauthApps');

Route::get('oauth/redirect',[GoogleAuth::class, 'redirect'])->name('redirect');
