            ...
            <div class="row">
              <div class="col-md-6">
                <ul class="nav nav-tabs custon-pill">
                  <li class="nav-item">
                    <a class="nav-link " aria-current="page"  href="{{ route('Apps.connection_apps',$slug)}}">Connections</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" href="#">Nits</a>
                  </li>
                </ul>
              </div>
              ...
              <div class="col-md-12">
                <div class="costom-box mt-2">
                  ...
                  <div class="col-md-4 text-left">
				   ...
				   <p><a href="#" class="Off_class">On</a> <strong>Last ran on • </strong><?php echo date('M, d, Y H:i',strtotime($zap_records->updated_at));?></p>
					<?php }?>
				  </div>
                  <div class="col-md-2">
                    <div class="dots">
