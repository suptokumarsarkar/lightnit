<section id="sidebar">
    <div class="moni_shortcut_link_wrapper">
        ...
        <a class="link  {{\Illuminate\Support\Facades\Request::is("apps/nits-list-history") ? "active" : "hover"}}"
           href="{{route('Apps.nits_list_history')}}">
            <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <!--<a class="link {{\Illuminate\Support\Facades\Request::is("apps/transfers") ? "active" : "hover"}}"  href="{{route('Apps.transfers')}}">
            <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <p>Transfers</p></a>--->
        <a class="link {{\Illuminate\Support\Facades\Request::is("apps/mynits") ? "active" : "hover"}}" href="{{route('Apps.mynits')}}">
            <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <p>My Apps</p></a>
        <a class="link {{\Illuminate\Support\Facades\Request::is("apps/nits-history") ? "active" : "hover"}}" href="{{route('Apps.nitshistory')}}">
            <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <a class="link hover" href="https://lightnit.com/explore/apps">
            <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <a class="link hover" href="https://lightnit.com/products/customer-stories">
            <svg width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
    ...
    <hr>
	<?php
	$current_plan = \App\Models\Plan::where('id',Auth::user()->plan_id)->first();
	$user = \App\Models\User::where('id',Auth::user()->id)->first();
	$d_data = (json_decode($user->user_data));
	?>		
    ...
    <div class="moni_free_plan">
        <div class="moni_free_plan_header">
            ...
            <h3><?php echo $current_plan->name;?> Plan</h3>
        </div>
        <div class="moni_users_content">
            <div class="moni_users">
                <div class="moni_users_wrapper">
                    ...
                    <span class="moni_text_number"><?php echo $d_data->tasks ?? "0";?> / <?php echo $current_plan->taskPerMonth ?? "0";?></span>
                </div>
            ...
            <div class="moni_users">
                <div class="moni_users_wrapper">
                    ...
                    <span class="moni_text_number"><?php echo $d_data->zaps ?? "0";?> /  <?php echo $current_plan->maxConnections ?? "0";?></span>
                </div>
                <div class="moni_progress_bar"></div>
            </div>
        ...
        <div class="moni_sidebar_under_btn">
            <a class="moni_sidebar_btn" href="{{route('Apps.pricings')}}">{{\App\Logic\translate('Upgrade plan')}}</a>
        </div>
    </div>
</section>
@push('MasterScript')
