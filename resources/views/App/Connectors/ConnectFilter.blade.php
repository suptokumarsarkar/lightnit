<div class="body_md_part" style="max-width: 1000px; width: 100%; margin: 0 auto;">
    @includeIf('App.Connectors.FTrigger', ['app' => $firstApp])
    @includeIf('App.Connectors.Filter', ['app' => $secondApp, 'first' => $firstApp])
    @includeIf('App.Connectors.FAction', ['app' => $secondApp, 'first' => $firstApp])
</div>
@push('headerScript')
    <link rel="stylesheet"
